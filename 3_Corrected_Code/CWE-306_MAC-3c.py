...
# Example Usage
user_password = getpass.getpass(prompt="Enter password for 'john_doe': ")
user = User(username="john_doe", email="john@example.com", password=user_password)

# User attempts to change email without logging in
user.change_email(old_email="john@example.com", password=user_password, new_email="john.doe@example.com")

# User logs in
user.login(password=user_password)
...
user.change_email(old_email="john.doe@example.com", password=user_password, new_email="johnny.doe@example.com")
