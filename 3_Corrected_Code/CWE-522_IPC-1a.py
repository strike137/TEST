...
def register():
    ...
    hashed_password = generate_password_hash(password)  # Correct generate_password_hash usage to default to pbkdf2:sha256
...
if __name__ == '__main__':
    if not os.path.exists('users.db'):
        init_db()
    # Use environment variable to set debug mode, defaulting to False for safety
